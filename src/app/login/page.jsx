      ...
      <div className="w-full max-w-md bg-[#090d16]/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-xl relative z-10 space-y-6 shadow-2xl">
        ...
        <div className="text-center space-y-1.5">
          ...
          <h1 className="text-2xl md:text-3xl font-black uppercase tracking-tight">
           Login <span className="text-[#00ffcc] drop-shadow-[0_0_10px_rgba(0,255,204,0.3)]">Your Acount</span>
          </h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="font-mono text-[12px] uppercase tracking-widest text-gray-400"> Email</label>
            <input
              type="email"
              name="email"
              required
          ...
          <div className="space-y-3">
            <label className="font-mono text-[12px] uppercase tracking-widest text-gray-400 ">Password</label>
            <input
              type="password"
              name="password"
              required
