    ...
    <footer className="bg-[#090d16] border-t border-white/5 py-12 px-4 md:px-8 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4 md:pl-12">
          ...
          <ul className="space-y-2 text-xs">
            <li>
              <Link href="/" className="text-gray-400 hover:text-[#00ffcc] transition-colors duration-300">
                Home
              </Link>
            </li>
            <li>
              <Link href="/cars" className="text-gray-400 hover:text-[#00ffcc] transition-colors duration-300">
                Explore Cars
              </Link>
            </li>
            <li>
              <Link href="/add-car" className="text-gray-400 hover:text-[#00ffcc] transition-colors duration-300">
                Add Car
              </Link>
            </li>
            <li>
              <Link href="/my-bookings" className="text-gray-400 hover:text-[#00ffcc] transition-colors duration-300">
                My Bookings
              </Link>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            ...
            <a 
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-sm font-black font-mono text-white hover:border-[#00ffcc] hover:text-[#00ffcc] transition-all duration-300"
              title="Follow on 𝕏"
            >
              𝕏
            </a>
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-xs font-bold text-white hover:border-[#00ffcc] hover:text-[#00ffcc] transition-all duration-300"
      ...
      <div className="max-w-7xl mx-auto border-t border-white/5 mt-10 pt-6 text-center">
        <p className="text-[10px] text-gray-500 font-mono tracking-wider">
          &copy; {new Date().getFullYear()} DRIVEFLEET OPERATIONS. ALL PROTOCOLS TERMINATED SAFELY.
        </p>
      </div>
    </footer>
  );
